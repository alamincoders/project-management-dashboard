  ...
  return (
    <div className="lg:ml-[20rem] bg-white ml-2 my-2 mr-2 lg:my-4 xl:my-8 lg:mr-4 xl:mr-8 p-2 lg:p-4 rounded">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        <div className="rounded border border-stroke bg-orange-200 px-7 py-6 shadow-default">
          <div className="flex h-11.5 w-11.5 rounded-full  ">
            <svg className="fill-primary " width="22" height="16" viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <div className="mt-4 flex items-end justify-between">
            <div>
              ...
              <span className="text-sm font-medium">Total Project</span>
            </div>
        ...
        <div className="rounded-sm border border-stroke bg-green-200 px-7 py-6 shadow-default">
          <div className="flex h-11.5 w-11.5  rounded-full  ">
            <svg className="fill-primary " width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <div className="rounded border border-stroke bg-violet-200 px-7 py-6 shadow-default">
          <div className="flex h-11.5 w-11.5  rounded-full  ">
          ...
          <div className="mt-4 flex items-end justify-between">
            <div>
              ...
              <span className="text-sm font-medium">InComplete Tasks</span>
            </div>
        ...
        <div className="rounded border border-stroke bg-primary/20 px-7 py-6 shadow-default">
          <div className="flex h-11.5 w-11.5 rounded-full  ">
            <svg className="fill-primary " width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
